export const MangaFormatObj = {
  ...
  WEB_LOVEL: {
    label: "Web novel",
    description:
      "Un roman qui est publié en ligne et qui se lit dans un navigateur.",
  },
  GRAPHIC_NOVEL: {
    label: "Graphic novel",
    description:
  ...
  ONE_SHOT: {
    label: "One shot",
    description:
      "Une histoire qui se termine après un seul chapitre ou un seul volume.",
  },
  OTHER: {
    label: "Autre",
...
export const MangaFormatArray = Object.keys(MangaFormatObj) as IMangaFormat[] &
  [string, ...string[]];
