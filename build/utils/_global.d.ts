...
export declare const TargetPathSelection: {
    label: string;
    value: "Manga" | "Anime" | "Groupe" | "Image" | "User" | "Account" | "UserProfile" | "UserPreferences" | "UserAnimeListe" | "UserDeleteAnimeFromListe" | "Person" | "Character" | "Track" | "Company" | "Patch" | "Activity" | "Report" | "DisabledUser" | "PremiumUser";
}[];
